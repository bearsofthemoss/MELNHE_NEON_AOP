...
plot_avg <- plot_avg[plot_avg$Age=="Young stands",]
...
top_arrows <- arrows_df[order(-arrows_df$magnitude), ][1:3, ]  # top 3
...
scale_factor <- (score_range * 0.5) / arrow_range
...
plot_avg <- plot_avg[plot_avg$Age=="Mid-aged stands",]
...
scale_factor <- (score_range * 0.05) / arrow_range
...
plot_avg <- plot_avg[plot_avg$Age=="Mature stands",]
...
scale_factor <- (score_range * 0.09) / arrow_range
