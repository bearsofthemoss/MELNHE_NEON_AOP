...
dati <- dati[dati$Stand %in% stands, ]
...
plsda_out <- here::here("R_output","PLSDA_output", group )
...
avg <-  read.csv(here::here("R_output","PLSDA_output",group,"results_summary_plsda_loso.csv"))


los <-  read.csv(here::here("R_output","PLSDA_output",group,"loso_results_by_stand.csv"))
...
count_data <- read.csv(here::here("R_output","PLSDA_output",group,"count_treatment_plsda_loso.csv"))
...
#  impo bands
vip<-  read.csv(here::here("R_output","PLSDA_output",group,"vip_scores_loso.csv"))
